...
import 'package:chat_gpt_app/manager/open_ai_key/repositories/open_ai_api_key_repository.dart'
    as _i6;
import 'package:chat_gpt_app/manager/theme/theme_manager.dart' as _i9;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  Future<_i1.GetIt> init({
    ...
    gh.lazySingleton<_i7.OpenAIKeyManagerProtocol>(
        () => _i7.OpenAIKeyManager());
    gh.lazySingleton<_i8.SecureStorageSourceProtocol>(
        () => _i8.SecureStorageSource());
    gh.lazySingleton<_i9.ThemeManagerProtocol>(() => _i9.ThemeManager());
    return this;
  }
}
